        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Table Edit Data Gallery Photo
                    </h4>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Gallery Photo</h4>
                            <form action="{{ route('gallery.update', $item->id)}}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly name="travel_packages_id"
                                        value="{{$item->travel_packages_id}}">
