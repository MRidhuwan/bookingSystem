        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Table Data transaksi</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <h4><a href="{{ route('transaction.create')}}"
                            class=" customize-input float-right btn btn-info">
                            <i class="fas fa-plus"> </i> Add Transaksi</a>
                            </h4> --}}
                        </div>
