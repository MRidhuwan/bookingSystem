        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Table Data gallery Photo</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Table gallery Photo</h4>
                            <h4><a href="{{ route('gallery.create')}}"
                                    class=" customize-input float-right btn btn-info">
                                    <i class="fas fa-plus"> </i> Add gallery Photo</a>
                            </h4>
                        </div>
