        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Table Add Data Paket Photo
                    </h4>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Add Paket Photo</h4>
                            <form action="{{ route('travel-package.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="location"
                                        placeholder="enter input location" value="{{ old('location')}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="feature_event"
                                        placeholder="enter input feature_event" value="{{ old('feature_event')}}">
                                </div>
                                <div class="form-group">
                                    <label for="language" class="text-info">language</label>
                                    <input type="text" class="form-control" name="language"
                                        placeholder="enter input language" value="{{ old('language')}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="departure_date"
                                        placeholder="enter input departure_date" value="{{ old('departure_date')}}">
                                </div>
                                <div class="form-group">
                                    <label for="duration" class="text-info">duration</label>
                                    <input type="text" class="form-control" name="duration"
                                        placeholder="enter input duration" value="{{ old('duration')}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="price"
                                        placeholder="enter input price" value="{{ old('price')}}">
                                </div>
                        </div>
